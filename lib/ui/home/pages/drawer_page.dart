...
import 'package:van_android_getx/ui/account/login_page.dart';
import 'package:van_android_getx/ui/home/vm/drawer_vm.dart';
import 'package:van_android_getx/ui/setting/setting_page.dart';
      ...
      child: ListView(
        ...
        children: <Widget>[
          DrawerHeader(
            ...
            child: Column(
              children: [
                Image.asset("assets/images/ic_nav_icon.png",
                    width: 64, height: 64),
